<?php // Wah, mulai deh PHP mode on, kayak nyalain mesin motor biar bisa jalan-jalan coding hari ini!

/**
 * Database Configuration // Ini komentar blok, kayak cerita panjang sebelum film dimulai, jelasin konfig database biar ga bingung nanti.
 *
 * This file handles the database connection for the school management system. // Lanjutin cerita, file ini urus koneksi database buat sistem sekolah, kayak manager yang atur jaringan.
 * Update the credentials below to match your MySQL database settings. // Saran update kredensial di bawah, cocokin sama setting MySQL kamu, biar ga salah sambung kayak nomor telepon yang salah.
 */

// Database configuration constants // Judul kecil, konstanta-konstanta buat database, biar nilai-nilai ini tetep konstan, ga ganti-ganti seenaknya kayak mood cewek.
...
// membuat koneksi ke database // Komentar satu baris, ini judul buat bagian koneksi, kayak "Sekarang kita bikin koneksi, siap-siap jalan!" sambil pegang stir.
try { // Try block, kayak coba dulu deh, kalau berhasil oke banget, kalau error ada catch-nya biar ga panik dan nangis.
    ...
    // Set charset to utf8mb4 for proper character support // Komentar, set charset utf8mb4, biar karakter aneh-aneh kayak emoji atau huruf asing bisa ditampilkan benar, ga rusak kayak foto yang blur.
    $conn->set_charset("utf8mb4"); // Panggil method set_charset, kayak atur bahasa di HP biar ga bingung baca pesan dari temen luar negeri.
